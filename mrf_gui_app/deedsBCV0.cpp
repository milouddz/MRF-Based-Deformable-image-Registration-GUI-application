...
int main (int argc, char * const argv[]) {
    ...
    unsigned long* im1_mind=new unsigned long[m*n*o];
    unsigned long* im1b_mind=new unsigned long[m*n*o];
    unsigned long* warped_mind=new unsigned long[m*n*o];
    ...
    for(int level=0;level<args.levels;level++){
        ...
        cout << "Time taken by primsGraph : "<< duration.count() << " milliseconds" << endl;
